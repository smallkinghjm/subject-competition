        ...
        <form class="layui-form"  method="post" id="from">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    ...
                    <input type="button" id="getCode" class="ui grey label layui-btn layui-btn-primary layui-border-orange" value="获取验证码">
                </div>
            </div>
            <div class="layui-form-item">
                <div class="layui-input-block" style="padding-left: 100px;">
                    <input type="button" class="layui-btn" id="btn" value="立即绑定" lay-submit lay-filter="*">
                </div>
            </div>
        </form>
    </div>
