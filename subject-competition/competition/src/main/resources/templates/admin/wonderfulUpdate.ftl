                ...
                <form class="layui-form" method="post" enctype="multipart/form-data">
                    <div class="layui-col-md3" >
                        ...
                        <div class="layui-upload-drag" id="cover">
                            <div  id="uploadDemoView">
                                <img src="${enclosure.enclosureContent}" alt="上传成功后渲染" style="max-width: 196px">
                            </div>
                        </div>
                    ...
                    <div class="layui-col-md9">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="title" id="title" value="${wonderful.title}" placeholder="标题" autocomplete="off" lay-verify="required" lay-reqtext="不能为空" class="layui-input" >
                        </div>
                    </div>
...
<script type="text/javascript">
    $(function () {
        ...
        editor.create();
        editor.txt.append('${wonderful.content}');//追加内容，必须放在这里
