...
//TODO 图片验证生成器
    ...
    public static final String RANDOMCODEKEY= "RANDOMVALDATECODEKEY";//放到session中的key
    private String randString = "23456789abcdefghjklmnopqrstuvwxyzABCDEFGHJKLMNPQRSTUVWXYZ";//随机产生数字与字母组合的字符串
